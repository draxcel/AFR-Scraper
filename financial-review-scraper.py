...
asx200_today = round(asx200.iloc[0, 6])
asx200_yesterday = round(asx200.iloc[1, 6])

asx200_diff = asx200_today - asx200_yesterday
...
print("Current S&P/ASX 200 Close:", asx200_today,
      sign, asx200_diff, '(', sign, round(asx200_diffper), '%', ')','\n')
